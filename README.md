...
- ❗ Linux/OSX users please stick to Manual Installation/Uninstallation instructions.
...
#### - 🚮 ***Manual Uninstallation:***
  - 1 - If the game updates to a new version the `steam_api64.dll` file, just remove `steam_api64_o.dll`  
