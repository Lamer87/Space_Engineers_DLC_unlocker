...
---
- ❗ [Plugin Launcher](https://github.com/sepluginloader/SpaceEngineersLauncher) is **NOT** compatible with latest versions of CreamAPI. Seems ok with 4.5.0.0. Investigating.
