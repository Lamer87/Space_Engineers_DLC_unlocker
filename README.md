...
---
- ❗ Linux/OSX version REMOVED because it was a mess. See [here](https://github.com/Lamer87/Space_Engineers_DLC_unlocker/discussions/45) (no knowledge to make it work like windows one).
