...
- 🚸 Newbies proof! Easy with an installer/checker and a remover.
...
- 🍨 If you now how to, you can even use [CreamInstaller](https://github.com/pointfeev/CreamInstaller) to build your own config.
