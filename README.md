...
- ‼️ Please try the new beta v1.7.0, test it with latest Pulsar and give me your feedback [here in this discussion](https://github.com/Lamer87/Space_Engineers_DLC_unlocker/issues/72)‼️
- ‼️ Only requirement: PULSAR FOLDER MUST BE INSIDE BIN64, NAMED just "Pulsar". ‼️
- ‼️ (like this: SpaceEngineers\Bin64\Pulsar\) ‼️
...
- ‼️‼️ REQUIRED PULSAR FOLDER INSIDE BIN64 (SpaceEngineers\Bin64\ ***Pulsar*** \ renamed just like this) ‼️‼️
---
---
<br>
...
- ⚠️ ***Troubleshooting:***
  ...
  - 🛡️ If you get the message "Windows protected your PC" when you launch "CreamAPI_Tool.cmd":  
    ...
    - 3 - If the "Run anyway" button is missing:
      ...
      - WINDOWS 10 - Go to: Start menu, Settings, Update & Security,  
  ...
  - ☑️ If you are not sure and you want to restore default game files through Steam:  
    ...
    To start game files check, you can:  
...
- 📑 ***Changelog***:
    ...
    - v0.6: Single cmd tool with some fixes; Backward compatible with all versions. ".ini" revised
...
- 🧰 What I need to do to setup CreamAPI starting from scratch?
