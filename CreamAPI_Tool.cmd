...
echo   ! [43;30m Checking... [0m
echo.
if exist SpaceEngineersLauncher.exe goto pluginlauncherdetected
...
cls
echo.
echo  ## [107;30m Space Engineers DLC Unlocker v1.6.6 - CreamAPI 5.3 - by Lamer87 [0m  [102m   [107m   [101m   [0m
echo.
echo.
...
echo.
echo.
echo   # [91m CreamAPI not installed (or game patched recently)[0m, do you want to:
echo.
