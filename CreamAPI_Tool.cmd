...
cls
echo.
echo  ## [107;30m Space Engineers DLC Unlocker v1.4 - CreamAPI - by Lamer87 [0m  [102m   [107m   [101m   [0m
echo.
echo.
...
echo N | comp /n=1024 steam_api64.dll Backup\CreamAPI\v5.1.0.0\steam_api64.dll >nul
cls
if errorlevel 1 goto checknewer3
if errorlevel 0 goto rollbackPL
:checknewer3
echo N | comp /n=1024 steam_api64.dll Backup\CreamAPI\v5.2.0.0\steam_api64.dll >nul
cls
...
echo  ## [107;30m Space Engineers DLC Unlocker v1.4 - CreamAPI - by Lamer87 [0m  [102m   [107m   [101m   [0m
echo.
echo   #  [102;30mPlugin Launcher[0m [92mpresence detected. Compatibility mode ENABLED. [0m
echo.
echo.
...
echo.
echo.
echo   -  Press "[106;30m R [0m" to just Restore the backup, keeping [1mCreamAPI[0m files.
echo.
echo   -  Press "[101;30m E [0m" to completely ERASE [1mCreamAPI[0m and restore the backup. Don't keep CreamAPI files.
echo.
echo   -  Press "[107;30m X [0m" to restart the Tool or "[44;97m A [0m" to abort.
...
echo.
echo.
echo   # [91m Newer CreamAPI version found![0m You NEED the old [1mv4.5[0m to use [103;30mPlugin Launcher[0m.
echo.
echo      What do you want to do?
echo.
echo.
echo   -  Press "[43;30m U [0m" to [92mrollback CreamAPI to v4.5[0m.
echo.
echo   -  Press "[106;30m R [0m" to just restore the original file, or "[101;30m E [0m" to completely ERASE [1mCreamAPI[0m.
echo.
echo   -  Press "[105;97m M [0m" if you want to ERASE all Plugin Launcher files (keeping CreamAPI).
echo.
